package edu.stevens.cs522.chat.oneway.client.CaptureClient;
 ...
 * Favor back-facing over front-facing camera.  */
    ...
    // TODO launch CameraActivity
        Log.d(TAG, "CpatureClient: the camid is " + Integer.toString(camid));
        ...
        Log.d(TAG, "CaptureClient: we have started the CaptureActivity ");
        return true;
    }
}
